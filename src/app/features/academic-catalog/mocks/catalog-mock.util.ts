...
const LEGACY_CONFLICT_MESSAGES: Record<string, string> = {
  ...
  PROFESSOR_ALREADY_INACTIVE: BACKEND_MESSAGES.ACADEMIC.PROFESSOR_ALREADY_INACTIVE,
  PROFESSOR_HAS_ACTIVE_ASSIGNMENTS: BACKEND_MESSAGES.ACADEMIC.PROFESSOR_HAS_ACTIVE_ASSIGNMENTS,
};
...
export function mockNotFound(codeOrMessage: string): HttpErrorResponse {
  const knownMessages: Record<string, string> = {
    ...
    PROFESSOR_NOT_FOUND: BACKEND_MESSAGES.ACADEMIC.PROFESSOR_NOT_FOUND,
